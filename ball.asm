; There is quite a bit of redundent or overly complex code mainly to test different features of the mc computer architecture i created. Programs like this should be able to run on the final version of the redstone computer which is being worked on
